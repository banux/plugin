...
// DefaultConfig returns the default Options of the Typescript plugin
...
func DefaultConfig() Config {
	...
	c := Config{Dir: root + pathSeparator, Ignore: nodeModules, Tsconfig: DefaultTsconfig()}
	c.Bin = npm.Abs("typescript/lib/tsc.js")
	return c
}
